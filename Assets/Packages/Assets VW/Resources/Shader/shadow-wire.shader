...
Shader "VW Shaders/Shadow-Unity5-Wireframe" { Properties { _Occlusionmap ("Occlusionmap", 2D) = "white" {} _Strength ("Strength", Range(0, 5) ) = 1 _WireframeBorder("Wireframe Border", Range(0, 1)) = 1.0 } SubShader { Tags { "RenderType"="Transparent" "Queue"="Transparent-10" "IgnoreProjector"="True" } Pass { Name "FORWARD" Tags { "LightMode"="ForwardBase" } Blend SrcAlpha OneMinusSrcAlpha Cull Back 
CGPROGRAM
#pragma geometry geo
#pragma vertex vert
