...
Shader "VW Shaders/Alu-Unity5" { 
	...
	_PaintFresnel ("Paint Fresnel", Float ) = 4 
	_BumpTex ("BumpTex", 2D) = "bump" {} 
	_SpecularFactor ("Specular Color Factor", Float) = 1 
	_DiffuseFactor ("Diffuse Color Factor", Float) = 0.5 
	_Occlusionmap ("Occlusionmap", 2D) = "white" {}  }

  SubShader { Tags { "RenderType"="Opaque" } Pass { Name "FORWARD" Tags { "LightMode"="ForwardBase" } Cull Back 
CGPROGRAM
