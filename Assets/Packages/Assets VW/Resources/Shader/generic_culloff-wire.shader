...
#endif
float3 i8 = reflect(-l7, i.normalDir); float3 k1 = normalize(_WorldSpaceLightPos0.xyz); float3 l6 = normalize(l7 + k1); half l8 = LIGHT_ATTENUATION(i); half3 l9 = l8 * _LightColor0.xyz; UnityLight light; 
#ifdef LIGHTMAP_OFF
