...
Shader "VW Shaders/Carpaint UV-Unity5-Wireframe" { Properties { _ClearcoatIntensity ("Clearcoat Intensity", Float ) = 1 _ClearFresnel ("Clearcoat Fresnel", Float ) = 6 _MinClearCoat ("Clearcoat Minimum", Float ) = 0.25 _ReflectionFalloff ("Reflection falloff", Float ) = 0.05 _DiffuseColor ("Diffuse Color", Color) = (0.5,0.5,0.5,1) _ReflectiveColor ("Reflective Color", Color) = (0.5,0.5,0.5,1) _Glossiness ("Glossiness", Float ) = 1 _PaintFresnel ("Paint Fresnel", Float ) = 0 _FlakeColor ("Flake Color", Color) = (0.2,0.2,0.2,1) _FlakesTex ("FlakesTex", 2D) = "flakes" {} _FlakeIntensity ("Flake Intensity", Float ) = 0.5 _FlakeDensity ("Flake Density", Float ) = 1 _FlakeViewDistance ("Flake View Distance", Float ) = 3 _MicroflakeSpecular ("Flake Specular", Float) = 0.75 _MicroflakePerturbation ("Flake Weight", Float) = 1 _NormalPerturbation ("Normal Weight", Float) = 0.5 _DiffuseFactor ("Diffuse Color Factor", Float) = 0.5 _SpecularFactor ("Specular Color Factor", Float) = 0.5 _Occlusionmap ("Occlusionmap", 2D) = "white" {} _WireframeBorder("Wireframe Border", Range(0, 1)) = 1.0 } SubShader { Tags { "RenderType"="Opaque" } Pass { Name "FORWARD" Tags{ "LightMode" = "ForwardBase" } Cull Back 
CGPROGRAM
#pragma geometry geo
#pragma vertex vert
