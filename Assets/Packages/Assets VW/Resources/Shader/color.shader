...
Shader "VW Shaders/Color-Unity5" { Properties { _DiffuseColor ("Diffuse Color", Color) = (0.5,0.5,0.5,1)  } SubShader { Tags { "RenderType"="Opaque" } Pass { Name "FORWARD" Tags { "LightMode"="ForwardBase" } Cull Back 
CGPROGRAM
