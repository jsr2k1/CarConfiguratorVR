...
public class Seat_Cover_Leather : MaterialExport {
	...
	public override Material CreateMaterial (XmlDocument doc, string path)
	{
		...
		float diffuseFactor = GetFloat (doc, "diffuseFactor", 0.6f);
		mat.SetFloat ("_DiffuseFactor", diffuseFactor);

		float specularFactor = GetFloat (doc, "specularFactor", 0.4f);
